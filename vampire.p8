...
function _update60()
	...
	if level_end then
		if level_end_timer<=80 then
			...
			level_start, level_end, level_end_timer, got_level_item = true, false, -20, false
			if not game_end then
