...
function actor:offscreen()
	return self.x<cam.x-self.width-32 or self.x>cam.x+128+32 or self.y+self.height<cam.y or self.y>cam.y+96
end
...
medusa = enemy:new({s=13, pal_type=2, timer=0, ignore_walls=true})
...
medusa_spawner = actor:new({timer=60, s=0})
...
entity_dict = {zombie, bat, cam_border_right, cam_border_left, platform:new({yw=24}), platform:new({xw=24}), platform:new({yw=-24}), pendulum, chicken, breakable_block, shooter, shooter:new({base_f=false}), axe_knight, batboss, boss_cam, heart_crystal, stone_sealing, key, medusa_spawner}
...
function _update60()
	...
	for a in all(actors) do
		if (a.y>=cam.y and a.y<cam.y+112) or a.always_update then
			a:update()
			if a.enemy and a.health<=0 and a:offscreen() then
				a.dead = true
			end
			if a.dead then
				del(actors, a)
...

...

__music__
03 0e424344
01 410f4344
00 41104344
