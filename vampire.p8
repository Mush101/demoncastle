...
function _init()
	...
	terminal_velocity, grav_acc, player_jump_height, player.health, player_max_health, health_timer, boss_health, boss_max_health, got_stones, e_timer, e_stones, blackout_time, darker_pal, darkness, e_add, level_start_timer, level_end_timer, level_start, difficulty_menu, progression, between_levels, p_width, p_timer,map_markers, deaths,minutes, seconds = 4, 0.15, 2.5, 6, 6, 0, 0,0, 0, 0.25, {}, 0, string_to_array("001121562493d52e"), 0, 0.01,0, -20, true, true, 0, false, 0,0, {{38,17}}, 0,0,0
	--boss_max_health = 6
